...
public class EjectAngle extends CommandBase {
    ...
    public EjectAngle(DrivebaseSubsystem drivebase, ShooterSubsystem shooter, double maxSpeed) {
        m_shooter = shooter;
    ...
    public void initialize() {
        ...
        m_distance = m_shooter.ejectAngleSetpoint;        
